...
@section('large-page-name','Edit')
@section('main-page-name','Appointments')
@section('small-page-name','Edit')
                        ...
                        <form id="create-form">
                            ...
                            <!--Time picker -->
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="no_hours_of_training"
                                           placeholder="Enter number hours of Training"
                                           name="no_hours_of_training" value="{{$appointment->no_hours_of_training}}">
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Saturday" {{$appointment->Saturday?'checked':''}} >
                                        <label for="Saturday">Saturday</label>
                                    </div>
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Sunday" {{$appointment->Sunday?'checked':''}}>
                                        <label for="Sunday">Sunday</label>
                                    </div>
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Monday" {{$appointment->Monday?'checked':''}} >
                                        <label for="Monday">Monday</label>
                                    </div>
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Tuesday" {{$appointment->Tuesday?'checked':''}}>
                                        <label for="Tuesday">Tuesday</label>
                                    </div>
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Wednesday" {{$appointment->Wednesday?'checked':''}}>
                                        <label for="Wednesday">Wednesday</label>
                                    </div>
                                    <div class="icheck-success d-block">
                                        <input type="checkbox" id="Thursday" {{$appointment->Thursday?'checked':''}}>
    ...
    <script>
        $(function () {
            ...
            $('#start_date').datetimepicker({
                ...
                useCurrent: false,
                // defaultDate:'ddd'
                defaultDate:'{{$appointment->start_date}}'
            });
            $('#end_date').datetimepicker({
                format: 'DD-MM-YYYY',
                defaultDate:'{{$appointment->end_date}}'
            });
            //Timepicker
            $('#start_time').datetimepicker({
                format: 'HH:mm:ss',
                {{--defaultTimeFormat:'{{$appointment->start_time}}'--}}
            });
